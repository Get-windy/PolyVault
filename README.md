...
PolyVault is built with a layered architecture: **eCAL** for communication, **zk_vault** for security, and **Flutter** for cross-platform UI.

PolyVault 采用分层架构：**eCAL** 负责通信，**zk_vault** 负责安全，**Flutter** 提供跨平台 UI。
